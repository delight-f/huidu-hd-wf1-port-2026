...
.PHONY: all clean fullclean flash monitor menuconfig help tidbyt-gen1 tidbyt-gen1_swap tidbyt-gen2 tidbyt-gen1-patched tidbyt-gen1_swap-patched tidbyt-gen2-patched tronbyt-s3 tronbyt-s3-wide pixoticker matrixportal-s3 matrixportal-s3-square matrixportal-s3-waveshare waveshare-s3 huidu-wf1
...
help:
	...
	@echo "  huidu-wf1                Build for Huidu HD-WF1 (ESP32-S2, 64x32 HUB75E)"
	@echo ""
...
huidu-wf1:
	$(call build_device,esp32s2,sdkconfig.defaults.huidu-wf1)
